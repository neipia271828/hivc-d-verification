...
def main() -> None:
    ...
    while not state.done:
        ...
        row = {
            ...
            # Legacy standalone smoke does not run the structured V protocol, but
            # it emits the complete §9.1 schema so its CSV can be merged/viewed.
            "role_value_mode": "legacy_unmeasured",
            "alpha_role_id": role_keys["alpha"] or "",
            "beta_role_id": role_keys["beta"] or "",
            "alpha_value_profile_id": "",
            "beta_value_profile_id": "",
            "alpha_value_profile_sha256": "",
            "beta_value_profile_sha256": "",
            "alpha_v_before": "",
            "beta_v_before": "",
            "alpha_action_before": "",
            "beta_action_before": "",
            ...
            "alpha_v_star_response": "[]",
            "beta_v_star_response": "[]",
            "alpha_v_after": "",
            "beta_v_after": "",
            "alpha_vote_changed": "",
            "beta_vote_changed": "",
            "alpha_v_star_consistent": "",
            "beta_v_star_consistent": "",
            "v_alignment_distance_before": float("nan"),
            "v_alignment_distance_after": float("nan"),
